...
export default function Navbar({
  ...
  return (
    <div
      id="bottom-navbar"
      className="fixed bottom-0 left-0 right-0 w-full overflow-x-hidden z-40 px-4 safe-area-bottom pt-2 bg-gradient-to-t from-slate-50/90 dark:from-slate-900/90 to-transparent pointer-events-none"
    >
