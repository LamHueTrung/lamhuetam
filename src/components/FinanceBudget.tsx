          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-[24px] p-4 text-white">
              ...
              <p className="text-xl font-black mt-1">
                {formatVND(salaryConfig.netSalary)}
              </p>
              <span className="text-[9px] opacity-70 block mt-1">
                Gross: {formatVND(salaryConfig.grossSalary)}
              </span>
            </div>
              ...
              <div className="flex gap-2">
                {COLOR_OPTIONS.map((c) => (
                  <button
                    ...
                    className={`w-7 h-7 rounded-full ${c.cls} ${catColor === c.key ? "ring-2 ring-offset-1 ring-slate-700" : ""} cursor-pointer transition-all`}
                  />
                ))}
              </div>
            </div>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-full hover:bg-rose-50 text-slate-300 hover:text-rose-500 cursor-pointer transition-all"
                      >
                  ...
                  <div className="space-y-2 mb-3">
                    {catTasks.map((task) => (
                      <div
                        key={task.id}
                        className="flex items-center gap-2 bg-slate-50 dark:bg-slate-700 rounded-2xl px-3 py-2"
                      >
                ...
                >
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-5">
                      ...
                      <button
                        onClick={() => setPaymentDebtId(null)}
                        className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-500 cursor-pointer shrink-0"
                      >
